@php
    ...
    $property_0 = App\Models\Property::where('state', $skip_state_0->state_name)->get();

    $skip_state_1 = App\Models\State::skip(1)->first();
    $property_1 = App\Models\Property::where('state', $skip_state_1->state_name)->get();

    $skip_state_2 = App\Models\State::skip(2)->first();
    $property_2 = App\Models\Property::where('state', $skip_state_2->state_name)->get();

    $skip_state_3 = App\Models\State::skip(3)->first();
    $property_3 = App\Models\Property::where('state', $skip_state_3->state_name)->get();
            ...
            <div class="items-container row clearfix">
                <div
                    ...
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset($skip_state_0->state_image) }}" style="width: 370px; height:580px" alt="">
                            </figure>
                            <div class="text">
                ...
                <div
                    ...
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset($skip_state_1->state_image) }}" style="width: 370px; height:275px" alt="">
                            </figure>
                            <div class="text">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all illustration marketing logo">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset($skip_state_2->state_image) }}" style="width: 370px; height:275px" alt="">
                            </figure>
                            <div class="text">
                ...
                <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all brand marketing print software">
                    <div class="place-block-one">
                        <div class="inner-box">
                            <figure class="image-box"><img src="{{ asset($skip_state_3->state_image) }}" style="width: 770px; height:275px" alt="">
                            </figure>
                            <div class="text">
