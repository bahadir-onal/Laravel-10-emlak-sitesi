                        ...
                        <div class="card">
                            <div class="card-body">
                              <h6 class="card-title">Add Property</h6>
                                <form id="myForm" method="post" action="{{ route('agent.update.property') }}" class="forms-sample" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="short_descp" id="exampleFormControlTextarea1" rows="3">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="long_descp" name="tinymce" id="tinymceExample" rows="10">
                                            {{ $property->long_descp }}
                                            </textarea>
